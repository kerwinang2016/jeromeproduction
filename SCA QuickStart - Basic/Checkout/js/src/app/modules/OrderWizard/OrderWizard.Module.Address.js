	...
	,	selectAddress: function (e)
		{
			...
			jQuery('[data-action="same-as"]').trigger('click');
			//this.markSameAs(true);//NOTE: This will auto set the billing address to be same as shipping address
		}
	...
	,	setAddress: function (address_id, options)
		{
			...
			// this.sameAs = true;
			// this.model.set('sameAs', true);
			// this.setAddress(true ? this.model.get(this.sameAsManage) : null);
			// this.tempAddress = true ? this.model.get('temp' + this.sameAsManage) : null;
