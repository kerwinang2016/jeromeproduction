	...
	,	render: function()
		{
			...
			if (this.state === 'present')
			{
				...
				//compute the total custom pricing for the tailor's order
				this.wizard.model.get("lines").each(function(line){
					if(line.get("options")){
						var customPrice = _.where(line.get("options"), {id: "CUSTCOL_TAILOR_CUST_PRICING"});
	...
	,	applyPromocode: function (e)
		{
			...
			this.wizard.model.save({ promocode: { code: options.promocode } }).error(
				function (jqXhr)
				{
