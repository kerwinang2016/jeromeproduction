	...
	,	render: function ()
		{
			...
			{
				var message = _('Checking out as a Guest. If you have an account, please $(0) and enjoy a faster checkout experience.').translate('<a href="login" data-toggle="show-in-modal">' + _('login').translate() + '</a>');
