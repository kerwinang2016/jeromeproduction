		...
		initialize: function (options)
		{
			...
			var mst_address_list = {
				...
				,	isActive: function (state)
					{
						return state && state.urlOptions === 'state=selectAddress' && this.wizard.model.get('ismultishipto');
					}
				,	isReady: function ()
					{
			...
			,	mst_address_packages = {
				...
				,	isActive: function (state)
					{
						return state && state.urlOptions === 'state=packages' && this.wizard.model.get('ismultishipto');
					}
				};
			...
			,	{
				...
				,	isActive: function (state)
					{
						return state && state.urlOptions === 'state=packages' && this.wizard.model.get('ismultishipto') && !options.is_opc;
					}
				}
			,	{
