/*global SC:false, Backbone:false, define:false, jQuery:false, jasmine:false */
...
define(['OrderWizard.Router', 'ItemDetails', './sampleCart', 'jasmineAjax', 'Application'],
	function (OrderWizardRouter, ItemDetails, sampleCart)
{
	'use strict';
